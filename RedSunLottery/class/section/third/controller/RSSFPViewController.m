...
@interface RSSFPViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation RSSFPViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    RSSFPViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"acell"];
    if (!cell) {
        cell = [[RSSFPViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"acell"];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.lid = self.lid;
    cell.model = _arrData[indexPath.section];
    return cell;
}
